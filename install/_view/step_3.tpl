    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <div id="logo" class="pull-right hidden-xs">
          <img src="_view/image/logo.png" alt="OpenCart" title="RNFengine" />
        </div>
      </div>
    </div>
  </header>
  ...
  <div class="row">
    ...
    <div class="col-sm-9">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="db_driver" id="input-db-driver" class="form-control">
                ...
                <?php } ?>
				<?php if ($mssql) { ?>
                <?php if ($db_driver == 'mssql') { ?>
                <option value="mssql" selected="selected"><?php echo $text_mssql; ?></option>
                <?php } else { ?>
                <option value="mssql"><?php echo $text_mssql; ?></option>
                <?php } ?>
                <?php } ?>
                <?php if ($pdo) { ?>
        ...
        <p><?php echo $text_tpl_type; ?></p>
        <fieldset>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-username"><?php echo $entry_tpl_type; ?></label>
            <div class="col-sm-10">
              <input type="text" name="tpl_type" value="<?php echo $tpl_type; ?>" id="input-tpl_type" class="form-control" />
            </div>
          </div>
		  <div class="form-group">
            <label class="col-sm-2 control-label" for="input-username"><?php echo $entry_tpl_protocol; ?></label>
            <div class="col-sm-10">
			  <input type="radio" name="protocol" value="http"  checked> HTTP &nbsp &nbsp
