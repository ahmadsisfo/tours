<?php
class Cadminspatialcity extends Controller {
	private $error 	= array();
	private $table 	= 'city';
    private $direc 	= 'admin/spatial/city';
	private $model  = 'Madminspatialcity';
	private $id		= 'city_id';
	private $fields	= array('maps','city_id','name','description');
	private $fieldlist = array('name','description');
	private $required = array('name','description');
	private $editable = 1;
