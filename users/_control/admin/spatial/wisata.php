<?php
class Cadminspatialwisata extends Controller {
	private $error 	= array();
	private $table 	= 'wisata';
    private $direc 	= 'admin/spatial/wisata';
	private $model  = 'Madminspatialwisata';
	private $id		= 'wisata_id';
	private $fields	= array('maps','wisata_id','wisata_jenis_id','name','address','phone','jambuka','jamtutup','biayamasuk','image');
	private $fieldlist = array('name','address','phone','image');
	private $required = array('wisata_jenis_id','name');
	private $editable = 1;
	private $select_wisata_jenis_id = array('table'=>'wisata_jenis','key'=>'name','value'=>'wisata_jenis_id');
