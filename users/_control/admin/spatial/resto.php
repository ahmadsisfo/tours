<?php
class Cadminspatialresto extends Controller {
	private $error 	= array();
	private $table 	= 'resto';
    private $direc 	= 'admin/spatial/resto';
	private $model  = 'Madminspatialresto';
	private $id		= 'resto_id';
	private $fields	= array('maps','resto_id','name','address','phone','jambuka','jamtutup','menu','image');
