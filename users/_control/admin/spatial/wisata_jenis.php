<?php
class Cadminspatialwisatajenis extends Controller {
	private $error 	= array();
	private $table 	= 'wisata_jenis';
    private $direc 	= 'admin/spatial/wisata_jenis';
	private $model  = 'Madminspatialwisatajenis';
	private $id		= 'wisata_jenis_id';
	private $fields	= array('wisata_jenis_id','name','ket');
	private $fieldlist = array('name','ket');
	private $required = array('name','keterangan');
	private $editable = 1;
