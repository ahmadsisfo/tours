<?php
class Cadminspatialukm extends Controller {
	private $error 	= array();
	private $table 	= 'ukm';
    private $direc 	= 'admin/spatial/ukm';
	private $model  = 'Madminspatialukm';
	private $id		= 'ukm_id';
	private $fields	= array('maps','ukm_id','ukm_jenis_id','name','address','phone','produk','image');
	private $fieldlist = array('ukm_jenis_id','name','address','phone','image');
	private $required = array('ukm_jenis_id','name');
	private $editable = 1;
	private $select_ukm_jenis_id = array('table'=>'ukm_jenis','key'=>'name','value'=>'ukm_jenis_id');
