<?php
class Cadminspatialukmjenis extends Controller {
	private $error 	= array();
	private $table 	= 'ukm_jenis';
    private $direc 	= 'admin/spatial/ukm_jenis';
	private $model  = 'Madminspatialukmjenis';
	private $id		= 'ukm_jenis_id';
	private $fields	= array('ukm_jenis_id','name','ket');
