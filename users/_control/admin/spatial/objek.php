<?php
class Cadminspatialobjek extends Controller {
	private $error 	= array();
	private $table 	= 'objek';
    private $direc 	= 'admin/spatial/objek';
	private $model  = 'Madminspatialobjek';
	private $id		= 'objek_id';
	private $fields	= array('objek_id','name','image','ket');
