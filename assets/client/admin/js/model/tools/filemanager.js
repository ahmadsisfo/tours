...
function Mtoolsfilemanager() {
	...
	$('a.thumbnail').on('click', function(e) {
		...
		$('#'+row).parent().parent().find('.thumb').attr('value', $(this).find('img').attr('src').split(LINK_IMG).join(''));
	...
	$('a.directory').on('click', function(e) {
		...
		$('#modal-image').load($(this).attr('href'), function(){
			Mtoolsfilemanager(); $(this).find('a').attr('row', row);
		});
	});
	...
	$('#button-search').on('click', function() {
		var row = $(this).attr('row'); 
		var url = SERVER + 'way=admin/tools/filemanager&sign=' + new_localStorage.get('sign') +'&directory='+$('#directory_now').val();
		$(this).tooltip('destroy');
	...
	$('#button-upload').on('click', function() {
		...
		$('#form-upload input[name=\'file\']').on('change', function() {
			...
			$.ajax({
				url: SERVER + 'way=admin/tools/filemanager/upload&sign=' + new_localStorage.get('sign') +'&directory='+$('#directory_now').val(),
				type: 'post',		
				dataType: 'json',
	...
	$('#button-folder').on('shown.bs.popover', function() {
		$('#button-create').on('click', function() {
			$(this).tooltip('destroy');
			$.ajax({
				url: SERVER + 'way=admin/tools/filemanager/folder&sign=' + new_localStorage.get('sign') +'&directory='+$('#directory_now').val(),
				type: 'post',		
				dataType: 'json',
	...
	$('#modal-image #button-delete').on('click', function(e) {
		...
		if (confirm('Apakah Anda yakin?')) {
			$.ajax({
				url: SERVER + 'way=admin/tools/filemanager/delete&sign=' + new_localStorage.get('sign'),
				type: 'post',		
				dataType: 'json',
